...
const Createpost = ({handleArticlePublish}) => {
  ...
  const [postType, setPostType] = useState('Blog'); // Default to 'Blog'
...
const sendArticleData = async (articledata) => {
    try {
      // Make POST request to localhost:9000
      const response = await axios.post(`${import.meta.env.VITE_YOUR_ENDPOINT}/article/publish`, articledata, {
      ...
      <div className="container mt-5">
        ...
        <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input className='coverphotos' type="file" id="photo" name="coverphoto" onChange={handlecoverChange} required/>
        </div>
        {coverphoto && (
            <div className="mb-3">
                <label className="form-label" htmlFor="coverphoto">
                ...
                <img className='coverphotos' src={URL.createObjectURL(coverphoto)} alt="Uploaded cover Photo" />
            </div>
        )}
        ...
        {imagephoto && (
            <div className="mb-3">
                ...
                <img className='coverphotos' src={URL.createObjectURL(imagephoto)} alt="Uploaded cover Photo" />
            </div>
        )}
          <div className="mb-3">
            <label className="form-label" htmlFor="Content1">
